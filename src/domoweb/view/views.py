...
def page(request, id=1):
    ...
    graphengine_cssfiles = GraphEngineCSS.objects.filter(graphengine__id__exact='nvd3')
    graphengine_jsfiles = GraphEngineJS.objects.filter(graphengine__id__exact='nvd3')
