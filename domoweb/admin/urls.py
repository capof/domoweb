...
urlpatterns = patterns('domoweb.admin.views',
    ...
    url(r'adddevice/(?P<plugin_host>[a-zA-Z0-9_.-]+)/(?P<plugin_id>[a-zA-Z0-9_.-]+)/(?P<plugin_type>\w+)/(?P<type_id>[a-zA-Z0-9_.-]+)/$', 'admin_add_device', name="admin_add_device_view"),
    url(r'deldevice/(?P<device_id>[\d]+)/(?P<plugin_host>[a-zA-Z0-9_.-]+)/(?P<plugin_id>[a-zA-Z0-9_.-]+)/(?P<plugin_type>\w+)/$', 'admin_del_device', name="admin_del_device_view"),
    ...
    url(r'core/deviceupgrade/$','admin_core_deviceupgrade',name='admin_deviceupgrade_view'),
)
